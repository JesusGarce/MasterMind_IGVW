...
método chequea, pero además almacena, por tanto el nombre no es correcto y puede llevar a error según
...
se encarga de solicitar a SecretCode que compruebe el String enviado por el usuario. En definitiva, lleva a
...
Cambios como este han sido muy comunes en la nueva versión del MasterMind en la cual se han
cuidado las peticiones Get.
