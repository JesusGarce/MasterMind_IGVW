...
Como podemos ver en la Figura 4, tenemos 20 clases Java, siendo 3 de ellas enumerados, separados en tres
paquetes: models, views y controllers. Hemos implementado una clase abstracta Controller a partir de la cual
